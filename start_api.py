#!/usr/bin/env python3
"""
LinkedIn Profile Finder API Startup Script
...
def check_chrome():
    ...
    try:
        ...
        print(f"❌ Chrome browser not found: {e}")
        print("\nTo fix this issue:")
...
def main():
    """Main function"""
    print("🔍 LinkedIn Profile Finder API")
    print("=" * 50)
    
    # Check if we're in the right directory
    if not Path("linkedin_finder.py").exists():
        print("❌ Error: linkedin_finder.py not found in current directory")
