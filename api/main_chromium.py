#!/usr/bin/env python3
"""
LinkedIn Profile Finder API - Chromium Version

FastAPI wrapper for the LinkedIn profile finder functionality.
Uses Chromium/Chrome with headless mode for better automation.
...
# Add parent directory to path to import linkedin_finder_chromium
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from linkedin_finder_chromium import Query, Result, find_profiles
...
app = FastAPI(
    title="LinkedIn Profile Finder API - Chromium",
    description="API for finding LinkedIn profile URLs using Google search with Chromium/Chrome headless browser",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def search_profile(request: SearchRequest):
    ...
    Uses Chromium/Chrome in headless mode for reliable automation.
